...
Original file is located at
    https://colab.research.google.com/drive/1cqh3kMXo3hJaVj5ElvG-kodH-fGdRHXQ
"""
...
# 1. OPTUNA - LIGHTGBM
print("\n1. Starting Optuna Optimization for LightGBM...")
...
def objective(trial):
    ...
    model = LGBMRegressor(**param_optuna)
...
model_optuna = LGBMRegressor(**best_params_optuna)
model_optuna.fit(X_train, y_train)

print("\n=== GENERATING LEARNING CURVE FOR OPTUNA OPTIMIZATION - LIGHTGBM ===")

def plot_learning_curve_optuna_lgb(model_params, model_name, X_train, X_valid, y_train, y_valid):
    """Plot learning curve for Optuna-optimized model (LightGBM)"""
...
# Jalankan untuk LightGBM hasil tuning Optuna
model_optuna_lgb_detailed = plot_learning_curve_optuna_lgb(
    best_params_optuna,
...
print("\n=== MODEL EVALUATION: BASELINE VS OPTUNA OPTIMIZATION (LightGBM) ===")
...
print(f"\n=== TRAINING TIME (Optuna Optimization - LightGBM) ===")
...
fig.suptitle('LightGBM: Baseline vs Optuna Optimization - Performance Comparison', fontsize=16)
