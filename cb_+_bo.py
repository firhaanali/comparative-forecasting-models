...
Original file is located at
    https://colab.research.google.com/drive/10Eq21RXDu3TMtEHThL5SBF2diMeswLOS
"""
...
param_bayes = {
    ...
    'rsm': Real(0.6, 1.0, prior='uniform'),
}

model_catboost_bayes = CatBoostRegressor(
    random_state=42,
    verbose=False,
    early_stopping_rounds=20
)
...
bayes_search = BayesSearchCV(
    estimator=model_catboost_bayes,
...
print("\n=== GENERATING LEARNING CURVE FOR BAYESIAN - CATBOOST ===")

def plot_learning_curve_bayes_cat(model_params, model_name, X_train, X_valid, y_train, y_valid):
    """Plot learning curve for Bayesian optimized model (CatBoost)"""
...
# Jalankan untuk CatBoost hasil tuning Bayesian
...
print("\n=== MODEL EVALUATION: BASELINE VS BAYESIAN OPTIMIZATION (CatBoost) ===")
...
print(f"\n=== TRAINING TIME (Bayesian Optimization - CatBoost) ===")
...
fig.suptitle('CatBoost: Baseline vs Bayesian Optimization - Performance Comparison', fontsize=16)
