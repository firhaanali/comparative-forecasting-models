...
Original file is located at
    https://colab.research.google.com/drive/10n7kDaifIyEx7CbfGSiqJMY3Mlrg0pkf
"""
...
# 1. RANDOM SEARCH - LIGHTGBM
print("\n1. Starting Random Search for LightGBM...")

param_random = {
    'max_depth': list(range(3, 11)),
    'learning_rate': np.logspace(-3, 0, num=100),  # log-uniform sampling between 0.001 and 1
    'n_estimators': list(range(50, 501)),
    'subsample': np.linspace(0.6, 1.0, num=41),
    'colsample_bytree': np.linspace(0.6, 1.0, num=41),
}

model_lgb_random = LGBMRegressor(
    objective='regression',
    random_state=42,
    verbosity=0
)
...
print("\n=== GENERATING LEARNING CURVE FOR RANDOM SEARCH - LIGHTGBM ===")

def plot_learning_curve_random_lgb(model_params, model_name, X_train, X_valid, y_train, y_valid):
    """Plot learning curve for Random Search optimized model (LightGBM)"""
...
# Jalankan untuk LightGBM hasil tuning Random Search
model_random_lgb_detailed = plot_learning_curve_random_lgb(
    best_params_random,
...
print("\n=== MODEL EVALUATION: BASELINE VS RANDOM SEARCH (LightGBM) ===")
...
print(f"\n=== TRAINING TIME (Random Search - LightGBM) ===")
print(f"Time: {(end_random - start_random) / 60:.2f} minutes")
...
fig.suptitle('LightGBM: Baseline vs Random Search - Performance Comparison', fontsize=16)
