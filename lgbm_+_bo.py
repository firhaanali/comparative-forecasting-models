...
Original file is located at
    https://colab.research.google.com/drive/1MWlCK37OTMq4V2lWaFgKsADCH2Tpzxh4
"""
...
# 1. BAYESIAN OPTIMIZATION - LIGHTGBM
print("\n1. Starting Bayesian Optimization for LightGBM...")
...
print("\n=== GENERATING LEARNING CURVE FOR BAYESIAN OPTIMIZATION - LIGHTGBM ===")

def plot_learning_curve_bayesian_lgb(model_params, model_name, X_train, X_valid, y_train, y_valid):
    """Plot learning curve for Bayesian optimized model (LightGBM)"""
...
# Jalankan untuk LightGBM hasil tuning Bayesian
model_bayes_lgb_detailed = plot_learning_curve_bayesian_lgb(
    best_params_bayes,
...
print("\n=== MODEL EVALUATION: BASELINE VS BAYESIAN OPTIMIZATION (LightGBM) ===")
...
# Waktu training Bayesian Optimization
print(f"\n=== TRAINING TIME (Bayesian Optimization - LightGBM) ===")
print(f"Time: {(end_bayes - start_bayes) / 60:.2f} minutes")
...
fig.suptitle('LightGBM: Baseline vs Bayesian Optimization - Performance Comparison', fontsize=16)
